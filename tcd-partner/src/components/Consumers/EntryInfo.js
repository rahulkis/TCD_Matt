...
import { CONSUMERS, ENTRIES } from "../../constants/AppConstant";
...
function EntryInfo() {
  ...
  const getEntriesInfo = async () => {
    try {
      ...
      await httpClient
        .get(
          CONSUMERS.GET_ENTRY_INFO+'/'+entryId
        )
        .then((res) => {
          if (res.data.success) {
              ...
              <div className="container-xl">
                <div className="row g-4 align-items-end ">
                  ...
                  >
                    ...
                    {/* <div className="col-md-5 app_home"></div> */}
                  </div>
                </div>
                <div className="common_padding" style={{ marginTop: "230px" }}>
                  <div className="row">
